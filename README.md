Creates a button in the N-panel of the 3D viewport, under the tool tab, to bake all your drivers to keyframes. It currently works for objects, shader nodes and geometry nodes.
